  ...
  return createPortal(
    <div className="fixed inset-0 z-[1000]">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4 py-8">
        <div
          className={[
            'w-full max-w-xl rounded-3xl border border-[var(--color-outine)] bg-[var(--color-section)] text-[var(--color-text)] shadow-[rgba(0,0,0,0.2)_0_1rem_2rem] transition-all duration-200',
        ...
        >
          ...
          {footer ? (
            <div className="flex items-center justify-end gap-3 border-t border-[var(--color-outine)] px-6 py-4">
              {footer}
            </div>
          ) : null}
        </div>
