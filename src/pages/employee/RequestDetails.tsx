    ...
    <div className={sectionStyles.section}>
      ...
      <div className="mb-5 flex justify-between items-center">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-2xl border border-[var(--color-outine)] bg-[var(--color-section)] px-4 py-2 font-semibold hover:bg-[color-mix(in_srgb,var(--color-action),transparent_90%)] text-[var(--color-action)] transition-colors cursor-pointer animate-fade-in"
        >
          <Printer size={16} />
          طباعة المعاملة
        </button>
